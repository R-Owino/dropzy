...
def test_delete_file_unauthorized(client: FlaskClient):
    ...
    response = client.delete("/api/v1/delete?file_key=testfile.txt")
...
def test_delete_file_invalid_file_key(client: FlaskClient):
    ...
    response = client.delete("/api/v1/delete?file_key=../../malicious.txt")
    assert response.status_code == 400
...
def test_delete_file_not_found(mock_delete, client: FlaskClient):
    ...
    response = client.delete("/api/v1/delete?file_key=nonexistent.txt")
...
def test_delete_file_forbidden(mock_delete, client: FlaskClient):
    ...
    response = client.delete("/api/v1/delete?file_key=protected.txt")
